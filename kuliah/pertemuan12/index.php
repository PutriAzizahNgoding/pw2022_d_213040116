...
// ketika tombol cari di klik, kita akan timpa mahasiswa nya dengan query pencarian
//putri%, depannya yang nama putri, belakangnya apapun
//%putri, belakangnya putri
if(isset($_GET["cari"])) {
